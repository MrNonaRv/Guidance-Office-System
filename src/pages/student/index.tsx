      ...
      >
        ...
        {isForgotPassword ? (
          ...
          <button 
            ...
            disabled={loading}
            className="w-full bg-[#1e4b9c] text-white py-3 rounded-2xl font-bold hover:bg-[#15397a] transition-colors flex items-center justify-center gap-3 shadow-sm text-[14px] cursor-pointer disabled:opacity-60">
